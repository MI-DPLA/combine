...
class Job(models.Model):
    ...
    def get_upstream_jobs(self, include_self=True, topographic_sort=True, depth=None):
    ...
    def remove_temporary_files(self):
        ...
        if self.job_type in ['HarvestStaticXMLJob']:
        ...
        # else, skip
            ...
            LOGGER.debug('Job type %s, does not have remove_temporary_files() method, skipping', self.job_type)
