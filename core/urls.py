...
from . import views
from .models import DTElasticFieldSearch
...
urlpatterns = [
	...
	url(r'^datatables/es/index/(?P<es_index>.+)/(?P<search_type>.+)/records_es_dt_json$', DTElasticFieldSearch.as_view(), name='records_es_dt_json'),
