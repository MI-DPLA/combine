...
+------------------------------------+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ``capture_attribute_values``       | ``array``                 | Array of attributes to capture values from and set as standalone field, e.g. if ``['age']`` is provided and encounters , a field ``foo_@age@`` would be created (note the additional trailing ``@`` to indicate an attribute value) with the value ``42``. [Default: ``[]``, Before: ``copy_to``, ``copy_to_regex``]                                                                                                   |
+------------------------------------+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ``concat_values_on_all_fields``    | [``boolean``, ``string``] | Boolean or String to join all values from multivalued field on character.  e.g. if the string ``,`` is provided, the encountered multivalue ``['foo','bar','baz']`` would be concatenated as ``foo,bar,baz`` [Default: **false**]                                                                                                                                                                                      |
+------------------------------------+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ``concat_values_on_fields``        | ``object``                | Key/value pairs for fields to concat on provided value, e.g. ``foo_bar``:``-`` would concatenate multiple values from ``foo_bar`` with string ``-`` [Default: ``{}``]                                                                                                                                                                                                                                                  |
+------------------------------------+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ``copy_to``                        | ``object``                | Key/value pairs to copy one field to another, e.g. ``foo``:``bar`` would create field ``bar`` and copy all values when encountered for ``foo`` to ``bar``, removing field ``foo``, unless ``remove_copied_key`` is set to **false**, which will maintain ``foo``.  Note: Can also be used to remove fields by setting the target field as false, e.g. ``foo``:**false**, would remove field ``foo`` [Default: ``{}``]  |
+------------------------------------+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ``copy_to_regex``                  | ``object``                | Key/value pairs to copy one field to another based on regex match of field, e.g. ``.*foo``:``bar`` would copy create field ``bar`` and copy all values fields ``goober_foo`` and ``tronic_foo`` to ``bar``.  Note: Can also be used to remove fields by setting the target field as false, e.g. ``.*bar``:false, would remove fields matching regex ``.*bar`` [Default: ``{}``]                                        |
+------------------------------------+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ``copy_value_to_regex``            | ``object``                | Key/value pairs that match values based on regex and copy to new field if matching, e.g. ``http.*``:``websites`` would create new field ``websites`` and copy ``http://example.com`` and ``https://example.org`` to new field ``websites`` [Default: {}]                                                                                                                                                               |
+------------------------------------+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+------------------------------------+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ``exclude_attributes``             | ``array``                 | Array of attributes to skip when creating field names, e.g. [``baz``] when encountering XML ``<tronic baz="42">foo</tronic>`` would result in field/value ``tronic``:``foo``                                                                                                                                                                                                                                           |
+------------------------------------+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+------------------------------------+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ``include_all_attributes``         | ``boolean``               | Boolean to consider and include all attributes when creating field names                                                                                                                                                                                                                                                                                                                                               |
+------------------------------------+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ``include_attributes``             | ``array``                 | Array of attributes to include when creating field names, when encountering XML ``<tronic baz="42">foo</tronic>`` would result in field/value ``tronic@age=42``:``foo``                                                                                                                                                                                                                                                |
+------------------------------------+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ``include_meta``                   | ``boolean``               | Boolean to include ``xml2kvp_meta`` field with output that contains these configurations [Default: false]                                                                                                                                                                                                                                                                                                              |
+------------------------------------+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+------------------------------------+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ``ns_prefix_delim``                | ``string``                | String to use as delimiter between XML namespace prefixes and elements, e.g. ``|`` XML ``tronic`` will create field name ``ns|foo_ns:bar`` [Default: ``|``]                                                                                                                                                                                                                                                            |
+------------------------------------+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+------------------------------------+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ``remove_ns_prefix``               | ``boolean``               | Boolean to determine if XML namespace prefixes are removed from field names, e.g. if False, XML ``tronic`` will result in field name ``foo_bar`` without ``ns`` prefix [Default: true]                                                                                                                                                                                                                                 |
+------------------------------------+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ``self_describing``                | ``boolean``               | Boolean to include machine parsable information about delimeters used (reading right-to-left, delimeter and its length in characters) as suffix to field name, e.g. if True, and ``node_delim`` is ``___`` and ``ns_prefix_delim`` is ``|``, suffix will be ``___3|1`` [Default: false]                                                                                                                                |
+------------------------------------+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+------------------------------------+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ``skip_repeating_values``          | ``boolean``               | Boolean to determine if a field is multivalued, if those values are allowed to repeat [Default: true]                                                                                                                                                                                                                                                                                                                  |
+------------------------------------+---------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
